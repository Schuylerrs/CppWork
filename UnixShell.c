...
*    Schuyler Summers
* Summary:
*    This is a simple shell program with history to learn how to handle
*    signals.
************************************************************************/
...
/***********************************************************************
 * Handels the QUIT signal by printing out the history
 * TODO: Add history outputting
 ***********************************************************************/
...
/***********************************************************************
 * Main gets the inputs from the user in a loop
 ***********************************************************************/
int main(void)
{
   ...
   while (1)                   /* Program terminates normally inside setup */
   {
      ...
      {
         // If it is not a background function wait for it to finish
         if (background != 1)
         {
            waitpid(pid, NULL, 0);
         }
